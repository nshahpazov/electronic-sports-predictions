...
def main(input_path, output_filepath):
    ...
    pipeline = FeatureUnion([
        ...
        # select rest that are not transformed
        ('rest', Pipeline([
    ...
    # pq.write_table(X_transformed, "datasets/processed/train_set.parquet")
    # input_df["radiant_win"].to_parquet("datasets/processed/train_set_y.parquet")
