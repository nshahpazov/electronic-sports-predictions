...
num_heroes = 113
# TODO: compare with the newly inserted one
...
if __name__ == '__main__':
	...
	hero_perc = {}
	# this is how they create the hash of hashes of arrays
  # TODO: compare the distributions of mmr and the other predictors
  # TODO: compare it for matches
  # TODO : допускаме, че mmr не се променя
    ...
    # TODO: check how is mmr estimated
	...
	for i in range(1, num_heroes+1):
			hero_player[str(i)] = {}
      # impute unknown with the median
